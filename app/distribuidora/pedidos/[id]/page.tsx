    ...
    <div className="min-h-screen bg-background flex flex-col pb-10">
      ...
      <div className="bg-white px-4 md:px-8 py-4 md:py-5 sticky top-0 z-20 shadow-sm flex items-center gap-3">
        ...
        <div className="flex-1">
          <h1 className="font-heading font-bold text-xl md:text-2xl text-gray-900">{order.orderNumber}</h1>
      ...
      <div className="px-4 md:px-8 mt-6 max-w-4xl mx-auto w-full space-y-4 md:space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          ...
          <div className="bg-white rounded-2xl md:rounded-3xl shadow-sm md:shadow-md border border-border p-5 md:p-8">
            <h2 className="font-bold text-gray-900 text-sm uppercase tracking-wider mb-6">Comercio</h2>
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <p className="font-bold text-gray-900 text-base md:text-lg">{order.comercioName}</p>
          ...
          {/* Entrega card */}
          <div className="bg-white rounded-2xl md:rounded-3xl shadow-sm md:shadow-md border border-border p-5 md:p-8">
            <h2 className="font-bold text-gray-900 text-sm uppercase tracking-wider mb-6">Entrega</h2>
            <div className="flex items-start gap-4">
              <div className="h-12 w-12 md:h-14 md:w-14 bg-red-50 text-primary rounded-2xl flex items-center justify-center shrink-0">
                <MapPin className="h-6 w-6" />
              </div>
              <div>
                <p className="font-bold text-gray-900 text-base">{order.comercioName}</p>
        ...
        {/* Products card */}
        <div className="bg-white rounded-2xl md:rounded-3xl shadow-sm md:shadow-md border border-border p-5 md:p-8">
          <h2 className="font-bold text-gray-900 text-sm uppercase tracking-wider mb-6">
            ...
            {order.items.map((item, i) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-bold text-sm md:text-base text-gray-900 leading-tight">{item.productName}</p>
                    <p className="text-sm text-muted-foreground mt-1">
                      {formatCurrency(item.unitPrice)} x {item.quantity} un.
                    </p>
                  </div>
                </div>
                <p className="font-heading font-bold text-gray-900 text-base md:text-lg shrink-0">
